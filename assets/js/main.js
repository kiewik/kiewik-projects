(() => {
  ...
  const translations = {
    en: {
      ...
      support_eyebrow:'Support development',support_title:'Keep independent tools moving forward.',support_text:'Horizon is free. Optional support helps fund testing, design work and future Kiewik Projects releases.',support_choice:'Choose whichever method is more convenient — both directly support the same Kiewik Projects development.',support_suppi_meta:'Poland · PLN',support_suppi_text:'Quick one-time support through the Polish Suppi platform.',support_suppi_p1:'One-time support',support_suppi_p2:'BLIK or card',support_suppi_btn:'Support via Suppi',support_bmac_meta:'International option',support_bmac_text:'International support through the Kiewik Projects Buy Me a Coffee page.',support_bmac_p1:'International support page',support_bmac_p2:'Direct link to Kiewik Projects',support_bmac_btn:'Open Buy Me a Coffee',
    ...
    pl: {
      ...
      support_eyebrow:'Wsparcie rozwoju',support_title:'Pomóż rozwijać niezależne narzędzia.',support_text:'Horizon jest bezpłatny. Dobrowolne wsparcie pomaga finansować testy, projektowanie i kolejne wydania Kiewik Projects.',support_choice:'Wybierz wygodniejszą metodę — obie bezpośrednio wspierają ten sam rozwój Kiewik Projects.',support_suppi_meta:'Polska · PLN',support_suppi_text:'Szybkie, jednorazowe wsparcie przez polską platformę Suppi.',support_suppi_p1:'Jednorazowe wsparcie',support_suppi_p2:'BLIK lub karta',support_suppi_btn:'Wesprzyj przez Suppi',support_bmac_meta:'Opcja międzynarodowa',support_bmac_text:'Międzynarodowe wsparcie przez profil Kiewik Projects w Buy Me a Coffee.',support_bmac_p1:'Międzynarodowa strona wsparcia',support_bmac_p2:'Bezpośredni profil Kiewik Projects',support_bmac_btn:'Otwórz Buy Me a Coffee',
